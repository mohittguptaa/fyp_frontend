...
const Banner = ({query,handleInputChange}) => {
  return (
    <div className='max-w-scrren-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14' >
      <h1 className='text-5xl font-bold text-primary mb-3'>Find your <span className='text-blue'> new job </span> today</h1>
      <p className='text-lg text-black/70 mb-8'>Thousands of jobs in the software field are waiting for you.</p>
      ...
      <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
          ...
          <button type = 'submit' className='bg-blue py-0 px-8 text-white md:rounded-s-none rounded '>Search</button>
